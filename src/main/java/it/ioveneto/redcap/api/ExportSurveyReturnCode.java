...
public class ExportSurveyReturnCode
{
	...
	public ExportSurveyReturnCode(final String api_token, final String format, final String url, final String event, final String instrument, final String record)
	{
